...
Supports both string-based and AsmNode-based optimization pipelines.
"""
...
def optimize_assembly(assembly_lines: List[str]) -> Tuple[List[str], int]:
    """
    Apply peephole optimizations to assembly code (string-based).
...
# ============================================================================
# Node-Based Peephole Optimization
# ============================================================================
