...
class TestRandRange:
    """Test rand_range!() macro."""

    @pytest.fixture
    def e2e(self):
        return E2ETest()

    def test_rand_range_compiles(self, e2e):
        """Test that rand_range! compiles and runs."""
        source = f'''
            include!("{SNESLIB_PATH}")
            include!("{MATH_PATH}")
            include!("{RAND_PATH}")
    ...
    def test_rand_range_max_1(self, e2e):
        """Test rand_range!(1) produces 0 or 1."""
        source = f'''
            include!("{SNESLIB_PATH}")
            include!("{MATH_PATH}")
            include!("{RAND_PATH}")
    ...
    def test_rand_range_max_254(self, e2e):
        """Test rand_range!(254) produces a value in [0, 254]."""
        source = f'''
            include!("{SNESLIB_PATH}")
            include!("{MATH_PATH}")
            include!("{RAND_PATH}")
    ...
    def test_rand_range_multiple_calls(self, e2e):
        """Test multiple rand_range! calls compile and run."""
        source = f'''
            include!("{SNESLIB_PATH}")
            include!("{MATH_PATH}")
            include!("{RAND_PATH}")
            ...
            #[entry]
            fn main() {{
                let a: u16 = rand_range!(10);
                R1[0] = a as u8;
                R1[1] = (a >> 8) as u8;

                let b: u16 = rand_range!(50);
                R2[0] = b as u8;
                R2[1] = (b >> 8) as u8;

                let c: u16 = rand_range!(200);
                R3[0] = c as u8;
                R3[1] = (c >> 8) as u8;
            }}
        '''
